...
import { requireCommunityAuth, optionalCommunityAuth } from '../../middleware/auth';
...
router.post('/profile/photo', requireCommunityAuth as any, parser.single('photo'), uploadPhoto as any);
router.post('/card/checkout', optionalCommunityAuth as any, checkoutCard as any);
