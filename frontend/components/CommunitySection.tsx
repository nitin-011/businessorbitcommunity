          ...
          <div className="flex flex-col lg:flex-row gap-[64px] lg:gap-[100px] items-center lg:items-start">
              ...
              >
                ...
                >
                  ...
                  <h3 className="font-glacial text-[22px] md:text-[24px] text-[#111111] font-bold leading-[1.3] mb-[24px]">
                    Find talent.
                    <br className="hidden md:block" /> Get mentorship. Scale
                    faster.
                  </h3>
                  ...
                  <ul className="space-y-[16px] mb-[40px]">
                    {[
                      ...
                      "Access mentors & operators",
                      "Connect with investors",
                    ].map((pt, i) => (
                      <li
                        key={i}
                        className="flex items-start text-[#6B7280] font-glacial text-[15px] md:text-[16px] leading-[1.5]"
                      >
                        <svg
                          className="w-[18px] h-[18px] text-[#86A810] mr-[12px] shrink-0 mt-[3px]"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                          strokeWidth={2.5}
                  ...
                  <div className="font-glacial text-[16px] text-[#111111] font-bold flex items-center group-hover:text-[#86A810] transition-colors duration-300">
                    Join as Founder{" "}
                    <ArrowRight className="ml-[8px] w-[18px] h-[18px] transition-transform duration-300 group-hover:translate-x-[4px]" />
                  </div>
                </Link>
              </motion.div>
            </div>
            ...
            <div className="w-full lg:w-[55%] flex flex-col order-1 lg:order-2 lg:pt-[100px]">
              ...
              >
                ...
                or a founder aiming to{" "}
                <span className="text-[#111111] font-medium">scale faster</span>
                , Business Orbit connects you to the{" "}
                <span className="text-[#111111] font-medium">right people</span>{" "}
                at the{" "}
                <span className="text-[#111111] font-medium">right time</span>.
              </motion.p>
            </div>
          </div>
        </div>
