      ...
      >
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-[24px] md:px-[48px]">
          ...
          >
            ...
            {/* Card 1 */}
            <motion.div variants={itemVariants} className="group flex flex-col bg-[#FFFFFF] border border-[#E5E7EB] rounded-[16px] p-[32px] transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)] hover:border-[#D1D5DB] shadow-sm relative overflow-hidden">
               {/* Icon */}
               ...
               <ul className="space-y-[14px] font-glacial text-[15px] md:text-[16px] text-[#6B7280] leading-[1.5] mb-auto">
                 <li><span className="font-bold text-[#111111]">10+</span> meetups organized</li>
                 <li><span className="font-bold text-[#111111]">5+</span> conferences hosted</li>
                 <li><span className="font-bold text-[#111111]">10+</span> offline speaker sessions</li>
                 <li><span className="font-bold text-[#111111]">10+</span> virtual sessions with real guidance</li>
                 <li><span className="font-bold text-[#111111]">3+</span> exclusive events</li>
               </ul>
            </motion.div>

            {/* Card 2 */}
            <motion.div variants={itemVariants} className="group flex flex-col bg-[#FFFFFF] border border-[#E5E7EB] rounded-[16px] p-[32px] transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)] hover:border-[#4F9DFF]/60 shadow-sm relative overflow-hidden ring-1 ring-inset ring-[#FFFFFF] hover:ring-[#4F9DFF]/10">
               <div className="mb-[24px] flex items-center justify-center w-[48px] h-[48px] rounded-full bg-[#FAFAFA] border border-[#E5E7EB] group-hover:scale-110 transition-transform duration-300">
               ...
               <ul className="space-y-[14px] font-glacial text-[15px] md:text-[16px] text-[#6B7280] leading-[1.5] flex-grow">
                 <li>Direct access to <span className="font-medium text-[#111111] border-b border-[#E5E7EB]">real founders</span></li>
                 <li>Internship & collaboration opportunities</li>
                 <li>Learn from people actually building</li>
                 <li>No fluff, only <span className="font-medium text-[#111111] border-b border-[#E5E7EB]">real exposure</span></li>
               </ul>
               <div className="mt-[32px] p-[16px] bg-[#FAFAFA] border border-[#F3F4F6] rounded-lg font-glacial text-[14px] text-[#4F9DFF] leading-[1.4] font-medium">
                 This community is completely free. No hidden charges. No paid access.
               </div>
            </motion.div>

            {/* Card 3 */}
            <motion.div variants={itemVariants} className="group flex flex-col bg-[#FFFFFF] border border-[#E5E7EB] rounded-[16px] p-[32px] transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)] hover:border-[#86A810]/60 shadow-sm relative overflow-hidden ring-1 ring-inset ring-[#FFFFFF] hover:ring-[#86A810]/10">
               <div className="mb-[24px] flex items-center justify-center w-[48px] h-[48px] rounded-full bg-[#FAFAFA] border border-[#E5E7EB] group-hover:scale-110 transition-transform duration-300">
               ...
               <ul className="space-y-[14px] font-glacial text-[15px] md:text-[16px] text-[#6B7280] leading-[1.5] mb-auto">
                 <li><span className="font-bold text-[#111111]">3+</span> startup pitching sessions</li>
                 <li>Network of <span className="font-bold text-[#111111]">20+</span> VCs</li>
                 <li><span className="font-bold text-[#111111]">30+</span> angel investors connected</li>
            ...
            <motion.div variants={itemVariants} className="group flex flex-col bg-[#FFFFFF] border border-[#E5E7EB] rounded-[16px] p-[32px] transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)] hover:border-[#D1D5DB] shadow-sm relative overflow-hidden">
               ...
               <ul className="space-y-[14px] font-glacial text-[15px] md:text-[16px] text-[#6B7280] leading-[1.5] mb-auto">
                 <li><span className="font-bold text-[#111111]">3+</span> professional conferences organized</li>
                 <li>Access to <span className="font-medium text-[#111111] border-b border-[#E5E7EB]">experienced operators</span></li>
