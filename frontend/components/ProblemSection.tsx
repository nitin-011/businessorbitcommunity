          ...
          <div className="flex flex-col md:flex-row relative">
            ...
            >
              <motion.div
                ...
                className="font-glacial text-[14px] text-[#A1A1A1] tracking-[0.1em] uppercase mb-[16px]"
              >
                STUDENTS
              </motion.div>
              <motion.h3
                variants={itemVariants}
                className={`${bebas.className} text-[32px] md:text-[40px] text-[#F5F5F5] uppercase leading-[1.1] mb-[32px]`}
              >
                Lost in noise. No real direction.
              </motion.h3>
              <ul className="space-y-[24px] font-glacial text-[16px] md:text-[18px] text-[#A1A1A1]">
                <motion.li variants={itemVariants} className="flex items-start">
                  <span className="text-[#4F9DFF] mr-[16px] mt-[4px] opacity-70">
                    —
                  </span>
                  <p>
                    Applying everywhere,{" "}
                    <span className="text-[#FFFFFF]">hearing back nowhere</span>
                  </p>
                </motion.li>
                <motion.li variants={itemVariants} className="flex items-start">
                  <span className="text-[#4F9DFF] mr-[16px] mt-[4px] opacity-70">
                  ...
                  <p>
                    Job portals filled with{" "}
                    <span className="text-[#FFFFFF]">irrelevant listings</span>
                  </p>
                </motion.li>
                <motion.li variants={itemVariants} className="flex items-start">
                  <span className="text-[#4F9DFF] mr-[16px] mt-[4px] opacity-70">
                  ...
                  <p>
                    ...
                    <span className="text-[#FFFFFF]">lead to nothing</span>
                  </p>
                </motion.li>
                <motion.li variants={itemVariants} className="flex items-start">
                  <span className="text-[#4F9DFF] mr-[16px] mt-[4px] opacity-70">
                  ...
                  <p>
                    <span className="text-[#FFFFFF]">No direct access</span> to
                    founders or decision-makers
                  </p>
                </motion.li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-[24px] font-glacial text-[16px] md:text-[18px] text-[#A1A1A1]">
                <motion.li variants={itemVariants} className="flex items-start">
                  <span className="text-[#D4FF3F] mr-[16px] mt-[4px] opacity-70">
                    —
                  </span>
                  <p>
                    Hard to find{" "}
                    <span className="text-[#FFFFFF]">
                      reliable, skilled talent
                    </span>
                  </p>
                </motion.li>
                <motion.li variants={itemVariants} className="flex items-start">
                  ...
                  <p>
                    No <span className="text-[#FFFFFF]">curated network</span>{" "}
                    of builders
                  </p>
                </motion.li>
                <motion.li variants={itemVariants} className="flex items-start">
                  ...
                  <p>
                    Events feel like{" "}
                    <span className="text-[#FFFFFF]">noise, not value</span>
                  </p>
                </motion.li>
                <motion.li variants={itemVariants} className="flex items-start">
                  <span className="text-[#D4FF3F] mr-[16px] mt-[4px] opacity-70">
                  ...
                  <p>
                    Struggling to connect with the{" "}
                    <span className="text-[#FFFFFF]">
                      right mentors or investors
                    </span>
                  </p>
                </motion.li>
              </ul>
