          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
            ...
            <div className="w-full lg:w-[55%]">
              <div className="w-full bg-[#FFFFFF] rounded-2xl md:rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-6 md:p-10">
                <h1 className={`${bebas.className} text-3xl md:text-[36px] text-[#111111] leading-[1] mb-2 uppercase`}>
                  Checkout
                </h1>
                <p className="text-base text-[#6B7280] mb-8">Complete your Orbit Card order</p>
                ...
                {status === 'error' && (
                  ...
                  >
                    ...
                    <span>Something went wrong placing your order. Please try again.</span>
                  </div>
                )}

                <form onSubmit={handleSubmit} className="space-y-4" data-testid="orbit-card-checkout-form">
                  <div>
                  ...
                  <div className="pt-2">
                    <div className="text-[#111111] font-medium text-sm mb-1">Delivery Address</div>
                    <p className="text-[#6B7280] text-xs mb-4">Your physical Orbit Card will be shipped here.</p>
                  </div>
                  ...
                  <div className="pt-2">
                    <label htmlFor="checkout-gstin" className="block text-[#111111] font-medium mb-1.5 text-sm">
                      GSTIN <span className="text-[#6B7280] font-normal">(optional, for a business invoice)</span>
                    </label>
                    <input
                      id="checkout-gstin"
                      type="text"
                  ...
                  <div className="pt-4">
                    ...
                    >
                      {status === 'processing' ? 'Processing...' : 'Confirm Order — ₹9,999'}
                    </button>
                  </div>
                </form>
              </div>
        ...
        {status === 'success' && (
          ...
          >
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-[#111111] mb-3">Order Initiated</h2>
              <p className="text-[#6B7280] mb-2 leading-relaxed">
                Your Orbit Card order has been initiated — we&apos;ve emailed your
                confirmation and receipt. Your physical card is being prepared and
                will be delivered to the address you provided.
              </p>
              <p data-testid="orbit-card-checkout-order-reference" className="text-[#111111] text-sm font-mono mb-8">
