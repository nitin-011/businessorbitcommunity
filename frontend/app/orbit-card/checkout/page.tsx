...
function StepIndicator({ step }: { step: "details" | "delivery" }) {
  return (
    <div
      ...
      data-testid="orbit-card-checkout-step-indicator"
    >
      <div
        className={`flex items-center gap-2 text-xs font-semibold ${step === "details" ? "text-[#111111]" : "text-[#9CA3AF]"}`}
      >
        <span
      ...
      <div
        className={`flex items-center gap-2 text-xs font-semibold ${step === "delivery" ? "text-[#111111]" : "text-[#9CA3AF]"}`}
      >
        <span
          className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] shrink-0 ${
            step === "delivery"
...
export default function OrbitCardCheckoutPage() {
  ...
  const cardDesignation = [formData.company, formData.designation]
    .filter(Boolean)
    .join(" — ");
      ...
      >
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
              ...
              <div className="w-full lg:w-[55%]">
                <div className="w-full bg-[#FFFFFF] rounded-2xl md:rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-6 md:p-8">
                  <h1
                    className={`${bebas.className} text-3xl md:text-[32px] text-[#111111] leading-[1] mb-1.5 uppercase`}
                  >
                    Checkout
                  </h1>
          ...
          >
            {paymentStatus === "error" ? (
              ...
              <>
                ...
                <h1 className="text-[#F5F5F5] text-lg font-semibold mb-2">
                  Processing your payment
                </h1>
                <p className="text-[#A1A1A1] text-sm">
                  Connecting securely — please don&apos;t close this page.
                </p>
              </>
            )}
          </motion.div>
        ...
        {step === "confirmation" && (
          ...
          >
            ...
            <h1
              className={`${bebas.className} text-3xl md:text-[40px] text-[#F5F5F5] uppercase leading-[1.05] mb-3`}
            >
              Order Confirmed
            </h1>
            <p className="text-[#A1A1A1] mb-2 leading-relaxed">
              Thanks, {formData.name.split(" ")[0] || "there"} — we&apos;ve
              emailed your confirmation and receipt. Your physical Orbit Card is
              being prepared and will be delivered to the address you provided.
            </p>
            <p
              data-testid="orbit-card-checkout-order-reference"
              className="text-[#F5F5F5] text-sm font-mono mb-10"
            >
