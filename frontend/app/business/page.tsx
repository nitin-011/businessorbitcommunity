            ...
            <div className="w-full bg-[#FFFFFF] rounded-2xl md:rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-6 md:p-10 flex flex-col justify-center">
              ...
              {!success ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#111111] font-medium mb-1.5 text-sm">Startup Name</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-[#111111] font-medium mb-1.5 text-sm">Stage of Startup</label>
                      <select
                  ...
                  <div>
                    <label className="block text-[#111111] font-medium mb-1.5 text-sm">LinkedIn / Website</label>
                    <input
                      type="url"
                      value={formData.role}
                  ...
                  <div className="pt-4">
                    ...
                    >
                      {applyMutation.isPending ? 'Submitting...' : 'Join as Founder — It’s Free'}
                    </button>
                  </div>
                </form>
              ) : (
                <div className="text-center py-8">
                  ...
                  <p className="text-[#6B7280] mb-8 leading-relaxed">
                    Thank you for applying. We'll review your founder profile and network credentials, and reach out to you directly soon.
                  </p>
                  <button
                    onClick={() => {
                        setSuccess(false);
                        setFormData({ name: '', company: '', role: '', stage: '', email: '', phone: '' });
                    }}
             ...
             <div className="w-full max-w-[650px] mx-auto lg:mr-auto lg:ml-0">
               ...
               >
                  ...
                  <p className="text-lg md:text-xl text-[#A1A1A1] leading-relaxed">
                    Skip the endless networking mixers and disconnected cold emails. Lock into an ecosystem that feeds founders direct access to top-tier execution talent, serious VCs, and operators playing the same game.
                  </p>
               </motion.div>
               ...
               <div className="space-y-12 md:space-y-16 relative before:absolute before:inset-0 before:ml-[15px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 md:before:left-[17px] before:h-full before:w-[2px] before:bg-gradient-to-b before:from-[#D4FF3F]/30 before:via-[#4F9DFF]/10 before:to-transparent before:hidden md:before:block">
                  ...
                  >
                     ...
                     <ul className="text-lg text-[#A1A1A1] space-y-3 list-disc list-inside">
                        <li>Access to <span className="text-[#FFFFFF] font-medium border-b border-[#333]">skilled, vetted students</span></li>
                        <li>Build your team <span className="text-[#FFFFFF] font-medium">faster</span></li>
                        <li>Work with people <span className="text-[#FFFFFF] font-medium">ready to execute</span></li>
                     </ul>
                  </motion.div>
                  ...
                  >
                     ...
                     <ul className="text-lg text-[#A1A1A1] space-y-3 list-disc list-inside">
                        <li>Connect intimately with <span className="text-[#FFFFFF] font-medium">20+ VCs</span></li>
                        <li>Network globally with <span className="text-[#FFFFFF] font-medium">30+ angel investors</span></li>
                        <li>Meet ambitious <span className="text-[#FFFFFF] font-medium border-b border-[#333]">founders and operators</span></li>
                     </ul>
                  </motion.div>
                  ...
                  >
                     ...
                     <ul className="text-lg text-[#A1A1A1] space-y-3 list-disc list-inside">
                        <li>Direct access to <span className="text-[#FFFFFF] font-medium border-b border-[#333]">3+ startup pitching sessions</span></li>
                        <li>Get direct structural <span className="text-[#FFFFFF] font-medium">exposure to investors</span></li>
                        <li>Real critical <span className="text-[#FFFFFF] font-medium">feedback, not noise</span></li>
                     </ul>
                  </motion.div>
                  ...
                  >
                     ...
                     <ul className="text-lg text-[#A1A1A1] space-y-3 list-disc list-inside">
                        <li>Access to highly raw, <span className="text-[#FFFFFF] font-medium">curated networking events</span></li>
                        <li>Platform to <span className="text-[#FFFFFF] font-medium border-b border-[#333]">speak, collaborate, and grow</span></li>
                        <li>Be an integral part of an <span className="text-[#FFFFFF] font-medium">organizing ecosystem</span></li>
                     </ul>
                  </motion.div>
                  ...
                  >
                     ...
                     <ul className="text-lg text-[#A1A1A1] space-y-3 list-disc list-inside">
                        <li>Skip the friction of <span className="text-[#FFFFFF] font-medium line-through decoration-[#FF4F4F]">cold outreach</span></li>
                        <li>Get instant access to <span className="text-[#FFFFFF] font-medium text-[#D4FF3F]">warm connections</span></li>
                        <li>Execute visions with <span className="text-[#FFFFFF] font-medium border-b border-[#333]">the exact right people</span></li>
                     </ul>
                  </motion.div>
                  ...
                  >
                     ...
                     <ul className="text-lg text-[#A1A1A1] space-y-3 list-disc list-inside">
                        <li>Exclusively <span className="text-[#FFFFFF] font-medium border-b border-[#333]">curated members only</span></li>
                        <li>Benefit from a truly <span className="text-[#FFFFFF] font-medium">high-signal network</span></li>
                        <li>Surrounded by people strictly <span className="text-[#FFFFFF] font-medium text-[#D4FF3F]">serious about growth</span></li>
                     </ul>
                  </motion.div>
